...
def validPassphraseChecker(inputList):
    validPassphraseNum = 0
    for i in inputList:
        dictCounter = {}
        validPassphrase = True

        for j in i:
            dictCounter[j] = dictCounter.get(j, 0) + 1
        ...
        if (validPassphrase):
            validPassphraseNum += 1

                
    return validPassphraseNum

#print validPassphraseChecker(test1)
#print validPassphraseChecker(inputValue)

def validPassphraseChecker2(inputList):
    validPassphraseNum = 0
    for i in inputList:
        dictCounter = {}
        validPassphrase = True
        ...
        for j in i:
            sortedValue = ''.join(sorted(j))
            print sortedValue
            dictCounter[sortedValue] = dictCounter.get(sortedValue, 0) + 1

            if dictCounter[sortedValue] > 1:
                validPassphrase = False
                break
...
print validPassphraseChecker2(inputValue)