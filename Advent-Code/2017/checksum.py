...
# inputMatrix will be an array of arrays or a flat matrix of the values 
def findCheckSum(inputMatrix):
    outputSum = 0
    for row in inputMatrix:
        ...
        outputSum = outputSum + (maxValue - minValue)

    return outputSum

# print findCheckSum(test1)
# print findCheckSum(inputItem1) 
    ...
    for row in inputMatrix:
        ...
        for i in range(0, len(row)):
            ...
            for j in range (i+1, len(row)):
                ...
                if ((divisor2 % divisor1) == 0 or (divisor1 % divisor2) == 0):
                    foundPair = True
                    break
        ...
        if (foundPair):
            ...
            if (divisor2 % divisor1) == 0:
                outputSum += divisor2/divisor1
            else:
                outputSum += (divisor1/divisor2)
            

    return outputSum

print findCheckSum2(test2)
print findCheckSum2(inputItem1)