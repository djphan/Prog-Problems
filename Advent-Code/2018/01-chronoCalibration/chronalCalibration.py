...
#calculateFrequency(test2)
#calculateFrequency(test3)
#calculateFrequency(inputValues)

test1Circular = [1, -1]
test2Circular = [3, 3, 4, -2, -4]
test3Circular = [-6, 3 ,8 ,5 -6]
test4Circular = [7, 7, -2, -7, -4]

def determineCircularFrequency(input):
    currentFrequency = 0
    frequencyTracker = set([0])
    breakLoop = False
    ...
    while(1):
        ...
        for i in input:
            currentFrequency += i
            if currentFrequency in frequencyTracker:
                breakLoop = True
                break
            else:
                frequencyTracker.add(currentFrequency)

    print (currentFrequency)

determineCircularFrequency(test1Circular)
determineCircularFrequency(test2Circular)
determineCircularFrequency(test3Circular)
determineCircularFrequency(test4Circular)
determineCircularFrequency(inputValues)